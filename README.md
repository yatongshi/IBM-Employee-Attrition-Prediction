# IBM HR Analytics Employee Attrition and Prediction
...
First, we will take a look at the relationship between Job Role and Attrition Rate.
 ...
 ![IBM-HR-Analytics-Employee-Attrition-and-Performance](images/job-role.png)
...
To add another layer, we want to see if the attrition rate has to do with monthly income.
 ...
 ![IBM-HR-Analytics-Employee-Attrition-and-Performance](images/monthly-income.png)
...
Does the years with current manager affect attrition?
 ...
 ![IBM-HR-Analytics-Employee-Attrition-and-Performance](images/years-with-manager.png)
...
To further understand, we will look at the specific breakdown of years with high attrition.
  1. The attributed employees that are first year with current Manager
      ...
      ![IBM-HR-Analytics-Employee-Attrition-and-Performance](images/attrition-reason-1.png)
      ![IBM-HR-Analytics-Employee-Attrition-and-Performance](images/attrition-reason-2.png)
      ![IBM-HR-Analytics-Employee-Attrition-and-Performance](images/attrition-reason-3.png)
...
How does the amount of business travel affect attrition?
   ...
   ![IBM-HR-Analytics-Employee-Attrition-and-Performance](images/business-travel.png)
